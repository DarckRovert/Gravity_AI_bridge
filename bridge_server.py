...
def run_server():
    ...
    log.info(
        "[V16.0 PRO] Security Monitor, Image Queue, Video Pipeline, Engine Watchdog, AI Process Manager activos."
    )
    ...
    log.info(
        f"Gravity Bridge V16.0 PRO — http://localhost:{port} | Dashboard: / | API: /v1"
    )
