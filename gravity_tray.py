"""
╔══════════════════════════════════════════════════════════════╗
║     GRAVITY AI BRIDGE V15.1 PRO — System Tray Manager           ║
...
def _build_menu(pystray):
    return pystray.Menu(
        pystray.MenuItem("Gravity AI Bridge V15.1 PRO", None, enabled=False),
...
def _pulse_loop(icon):
    ...
    icon.title = "Gravity AI Bridge V15.1 PRO — Online"
...
def run_tray():
    ...
    icon = pystray.Icon(
        ...
        icon    = img,
        title   = "Gravity AI Bridge V15.1 PRO — Iniciando...",
        menu    = menu,
    )
