"""
╔══════════════════════════════════════════════════════════════╗
║     GRAVITY AI BRIDGE V16.3 PRO — System Tray Manager           ║
...
def _build_menu(pystray):
    return pystray.Menu(
        pystray.MenuItem("Gravity AI Bridge V16.3 PRO", None, enabled=False),
...
def _pulse_loop(icon):
    ...
    icon.title = "Gravity AI Bridge V16.3 PRO — Online"
