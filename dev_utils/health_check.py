...
def main():
    ...
    console.print(Align.center(Panel(Text("SISTEMA DE DIAGNÓSTICO V8.0 PRO", justify="center", style="bold bright_white"), style="on bright_black", box=box.HEAVY_EDGE, padding=(0,2))))
