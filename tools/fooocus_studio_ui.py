"""
Gravity AI Bridge V15.0 PRO -- Vision Studio UI
...
with gr.Blocks(title="Gravity Vision Studio V15.0 PRO", css=custom_css) as demo:
    gr.Markdown(
        "## Gravity Vision Studio V15.0 PRO\n"
...
if __name__ == "__main__":
    ...
    print(f"[Gravity Vision Studio V15.0 PRO] Iniciando en http://127.0.0.1:{_port}")
    print(f"[Gravity Vision Studio V15.0 PRO] Motor Fooocus CPU en http://127.0.0.1:7861")
    print(f"[Gravity Vision Studio V15.0 PRO] Output dir: {OUTPUT_DIR}")
    demo.launch(
