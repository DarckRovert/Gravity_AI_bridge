...
**Instalador (.exe):**
Descarga y ejecuta el nuevo `Gravity_AI_Bridge_V11.0_Setup.exe`. El instalador preserva tu `config.yaml` y `_knowledge.json`.
