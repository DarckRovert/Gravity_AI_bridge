...
Con la V11.0 de Gravity, no necesitas saber de Linux ni instalar Apache para tener un servidor o crear cuentas. Gravity funciona como el orquestador principal.
