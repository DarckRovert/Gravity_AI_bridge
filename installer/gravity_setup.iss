; ═══════════════════════════════════════════════════════════════════════════════
; GRAVITY AI BRIDGE V10.0 — Inno Setup Script
...
VersionInfoDescription={#AppName} — Orquestador de IA Local de Alto Rendimiento
...
[Tasks]
Name: "desktopicon";        Description: "Crear icono en el Escritorio";          GroupDescription: "Accesos Directos:"; Flags: checked
Name: "startmenufolder";   Description: "Crear carpeta en el Menú de Inicio";    GroupDescription: "Accesos Directos:"; Flags: checked
...
[UninstallRun]
Filename: "taskkill.exe"; Parameters: "/F /IM {#AppExe}"; Flags: skipiferror
...
begin
  WizardForm.WelcomeLabel2.Caption :=
    'Este asistente instalará Gravity AI Bridge V10.0 en tu computadora.' + #13#10 + #13#10 +
    ...
    'Compatible con LM Studio, Ollama, Kobold, Jan y más.' + #13#10 + #13#10 +
