; ══════════════════════════════════════════════════════════════════════════════
; GRAVITY AI BRIDGE V15.1 PRO — Inno Setup Script
...
VersionInfoDescription={#AppName} — Orquestador de IA Local Omniscient-Tier V15.1 PRO
...
begin
  WizardForm.WelcomeLabel2.Caption :=
    'Este asistente instalará Gravity AI Bridge V15.1 PRO en tu computadora.' + #13#10 + #13#10 +
