# 🍰 Tutorial de Configuración — Plantilla Maestra
...
Crea el archivo `.env.local` en la raíz de `gravity-web-core/` si no existe:
...
# 2. Asocia el proyecto (ejecuta desde la raíz de gravity-web-core)
...
*Tutorial generado el 03/03/2026 · Proyecto: Plantilla Maestra · Arquitecto: DarckRovert*
