"""
╔══════════════════════════════════════════════════════════════════════════════╗
║      GRAVITY AI BRIDGE - AUDITOR SENIOR V15.2 PRO [Ecosistema Total]               ║
...
class SettingsManager:
    """Surgical wrapper for ConfigManager V15.2 PRO compatibility."""
    def __init__(self):
        self.config = config
        self.data = {
...
def first_run_check():
    ...
    _console.print(Panel(
        Align.center(
            "[bold white]Bienvenido a Gravity AI Bridge V15.2 PRO[/]\n"
...
class AuditorCLI:
    ...
    def _load_system_prompt(self, kb_data: dict = None) -> str:
        ...
        if mode == "Omni-Audit":
            base += (
                "\nMODO: Omni-Audit (V15.2 PRO Premium). "
...
» Modo:  [dim]{hw['gpu_type'].upper()}[/]"""
    ...
    def cmd_help(self):
        ...
        console.print(Panel(t, title="[bold cyan]Comandos Disponibles - Gravity AI V15.2 PRO[/]", border_style="blue"))
    ...
    def interactive_loop(self):
        ...
        while True:
            try:
                ...
                # V15.2 PRO: Inyectar MemDir (conocimiento de directorio) antes de buscar RAG
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(
        prog="ask_deepseek",
        description="Gravity AI Bridge V15.2 PRO CLI",
        add_help=False,
    )
