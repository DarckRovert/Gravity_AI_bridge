"""
╔══════════════════════════════════════════════════════════════════════════════╗
║      GRAVITY AI BRIDGE - AUDITOR SENIOR V10.0 [Ecosistema Total]               ║
...
class SettingsManager:
    """Surgical wrapper for ConfigManager V10.0 compatibility."""
    def __init__(self):
        self.config = config
        self.data = {
...
def first_run_check():
    ...
    _console.print(Panel(
        Align.center(
            "[bold white]Bienvenido a Gravity AI Bridge V10.0[/]\n"
...
» Modo:  [dim]{hw['gpu_type'].upper()}[/]"""
    ...
    def cmd_help(self):
        ...
        console.print(Panel(t, title="[bold cyan]Comandos Disponibles - Gravity AI V10.0[/]", border_style="blue"))
