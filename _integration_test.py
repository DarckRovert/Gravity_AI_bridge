...
def run_tests():
    ...
    server_process = subprocess.Popen(["python", "bridge_server.py"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    tests = [
        {"name": "Tool: Search", "path": "/v1/tools/search", "payload": {"query": "python 3.11 release date"}},
        {"name": "Tool: Git", "path": "/v1/tools/git", "payload": {"cmd": "status"}},
        {"name": "Tool: Code Run", "path": "/v1/tools/run", "payload": {"code": "print('Hello World')", "lang": "python"}},
        {"name": "Tool: Scrape", "path": "/v1/tools/scrape", "payload": {"url": "https://example.com"}},
        {"name": "Config: RAG Toggle", "path": "/v1/rag/toggle", "payload": {}},
        {"name": "Config: Bounty Profile", "path": "/v1/bounties/profile", "payload": {"profile": "Test Freelancer Profile"}},
    ]
