...
def main():
    ...
    console.print(Align.center(Panel(Text("SISTEMA DE DIAGNÓSTICO V10.1 PRO", justify="center", style="bold bright_white"), style="on bright_black", box=box.HEAVY_EDGE, padding=(0,2))))
